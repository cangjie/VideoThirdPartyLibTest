...
inline void flv_put_num_to_buf(unsigned char szNum[],const char * psrc,int dstLenght)
{
...
int   cc_flv_build_header(unsigned char *pdst,int ndstlen,const SBuildFileHeader* pData,AMFHeaderOutPos* out);
